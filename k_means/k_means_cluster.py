...
scaled_sal = min_max_scaler.fit_transform(sal)
print float(min_max_scaler.scale_ * 200000)

scaled_eso = min_max_scaler.fit_transform(eso)
print float(min_max_scaler.scale_ * 1000000)
